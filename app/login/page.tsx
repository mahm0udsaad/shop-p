      ...
      <main className="flex-1 grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="hidden md:flex flex-col items-center justify-center bg-gradient-to-br from-[#6F4E37]/10 to-[#A67B5B]/20 p-8">
          <div className="flex flex-col items-center max-w-md text-center">
            ...
            <h2 className="text-2xl font-bold text-[#6F4E37] mb-4">Showcase Your Products</h2>
            <p className="text-[#A67B5B]">
              Create beautiful product pages and grow your business with our powerful platform.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center py-12 px-4">
          ...
          >
            <div className="mb-8 text-center">
              ...
              <h1 className="text-2xl font-bold tracking-tight text-[#6F4E37]">Welcome back</h1>
              <p className="text-sm text-[#A67B5B] mt-1">Sign in to your account to continue</p>
            </div>
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-[#A67B5B]">
                ...
                <Link href="/signup" className="font-medium text-[#6F4E37] hover:underline">
                  Sign up
                </Link>
              </p>
            </div>
